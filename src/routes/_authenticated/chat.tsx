  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 select-none overflow-hidden">
        ...
        <div
          className="drift absolute top-2/3 -right-10 text-6xl opacity-10"
          style={{ animationDelay: "-9s", animationDuration: "18s" }}
        >
          🌷
        </div>
        <div
          className="float-slow absolute top-12 left-4 text-4xl opacity-10"
          style={{ animationDelay: "-2s", animationDuration: "8s" }}
        >
          🌹
        </div>
        <div
          className="drift absolute bottom-1/3 left-6 text-5xl opacity-10"
          style={{ animationDelay: "-13s", animationDuration: "20s" }}
        >
          🌺
        </div>
      </div>
