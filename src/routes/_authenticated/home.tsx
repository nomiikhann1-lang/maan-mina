  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col overflow-hidden bg-background">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 select-none overflow-hidden">
        ...
        <div
          className="drift absolute top-3/4 -right-8 text-6xl opacity-10"
          style={{ animationDelay: "-11s", animationDuration: "19s" }}
        >
          🌷
        </div>
        <div
          className="float-slow absolute top-16 left-6 text-4xl opacity-10"
          style={{ animationDelay: "-4s", animationDuration: "7s" }}
        >
          🌹
        </div>
        <div
          className="drift absolute bottom-1/4 left-4 text-5xl opacity-10"
